...
const Form = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        // Save admin email for client-side display (used to show admin name)
        ...
        <div className="left-panel">
          ...
          <div className="hero-text">
            ...
            <div className="hero-desc">
              Secure access to portfolio analytics and management.
            </div>
        ...
        <div className="right-panel">
          <div className="form-wrapper">
            ...
            <form onSubmit={handleLogin}>
              ...
              <div className="hint-text">Enter your admin credentials.</div>
              <button
                type="submit"
            ...
            <div className="footer-text">
              Admin-only access • Session expires in 30 minutes
            </div>
          </div>
        </div>
      </div>
